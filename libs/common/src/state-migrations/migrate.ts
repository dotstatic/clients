...
import { MoveBiometricPromptsToStateProviders } from "./migrations/15-move-biometric-prompts-to-state-providers";
...
export async function migrate(
  ...
  await MigrationBuilder.create()
    ...
    .with(MoveBiometricPromptsToStateProviders, 14, CURRENT_VERSION)
